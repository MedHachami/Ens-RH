<?php
	...
	$sql = "SELECT * FROM services_notifications ORDER BY id DESC ;" ;
    ...
    <div >
        ...
        <div class="row">
            ...
            <div class="col-md-8">
				...
				?>		
					<div class="card" style="width: 18rem;">
						<div class="card-body">
							<h5 class="card-title">Demande d'<?php echo $r['Topic']  ;?></h5>
							<p class="card-subtitle mb-2 text-muted" >par <?php echo $r['Nom'] . " " . $r['Prenom']  ;?></P>
							<form action="includes/NotificationTraitement.php " method="POST">
							<input type="submit" name="Seen" value="Vue" class="btn btn-success">
							<input type="submit" name="Imprimer" value="Imprimer" class="btn btn-success">
							<input type="submit" name="Delete" value="Delete" class="btn btn-danger">
							<input type="hidden" name="UniqId" value="<?php echo $r['UniqId']  ?>">
							<input type="hidden" name="userId" value="<?php echo $r['userId']  ?>">
							<input type="hidden" name="Topic" value="<?php echo $r['Topic']  ?>">
							</form>
			...
			<table class="table">
				...
				$sql2 = "SELECT * FROM services_archive  ; " ;
