...
$sql3 = "SELECT * FROM reclamations_notifications ; " ;
            ...
            <div class="col-md-12">
                <div class="profile-head">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">New reclamation</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="tab-content profile-tab" id="myTabContent">
					<div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
						...
						<div class="card " style="width: 18rem;">
							<div class="card-body">
								<h5 class="card-title"><?php echo $r3['description']  ;?></h5>
								<p class="card-subtitle mb-2 text-muted" >par <?php echo $r3['Nom'] . " " . $r3['Prenom']  ;?></P>
								<?php $url = $r3['imgReclamtion'] ; ?>
								
								
								<img src="../DB/uploads/reclamationsImg/<?php echo $url ; ?>" class="reclamation-img" alt="">
								<form action="includes/ReclamationTraitement.php" method="POST">
								<input type="submit" name="Seen" value="Vue" class="btn btn-success">
								<input type="submit" name="processed" value="Traiter" class="btn btn-info">
								<input type="submit" name="Delete" value="Effacer" class="btn btn-danger">
								<input type="hidden" name="id" value="<?php echo $r1['id'] ;?> ">
								<input type="hidden" name="imgReclamtion" value="<?php echo $r3['imgReclamtion'] ;?> ">
					...
					<table class="table">
						...
						$sql2 = "SELECT * FROM reclamations_archive  ; " ;
