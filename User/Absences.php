            ...
            <div class="col-md-12">
                <div class="profile-head">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">ADD Justification</a>
                        </li>
            ...
            <div class="col-md-8">
                <div class="tab-content profile-tab" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                        <form action="includes/AbsenceTraitement.php" method="post" enctype="multipart/form-data">
                    ...
                    <br>
                        ...
                        <div  class="form-group">
                        <label >Date </label><br>
                        <input type="date" name="dateJustif" id="">
                        </div>
                        <div  class="form-group">
