...
include_once '../DB/dbh.php' ;
    session_start();
    $id = $_SESSION['id'];
    $sql = "SELECT * FROM services_archive WHERE userId = $id  ;" ;
            ...
            <div class="col-md-12">
                <div class="profile-head">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">My Demands</a>
                        </li>
                            ...
                            <?php 
                               ...
                               foreach($result as $r) { ?>
                                ...
                                <tr>
                                    ...
                                    <td>Demande d'<?php echo $r['Topic'] ;    ?></td>  
