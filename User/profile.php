    ...
    <div >
        <div class="row">
            <div class="col-md-4">
                ...
                <img src="../DB/uploads/ProfileImages/<?php echo $_SESSION['cne'] ;?>.jpg" alt="" class="user"/>
            ...
            <div class="col-md-6">
                <div class="profile-head">
                            ...
                            <h6>
                                <?php echo $_SESSION['Echelon'] ; ?>
                            </h6>
                            <p class="proile-rating">Grade : <span><?php echo $_SESSION['Grade'] ; ?></span></p>
            ...
            <div class="col-md-2">
                <a href="settings.php" class="profile-edit-btn">Edit Profile</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="tab-content profile-tab" id="myTabContent">
                    <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><?php echo $_SESSION['Situation_Familiale'] ;?></p>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <p><?php echo $_SESSION['Date_Recrutement'] ;?></p>
                                    </div>
                                </div>
